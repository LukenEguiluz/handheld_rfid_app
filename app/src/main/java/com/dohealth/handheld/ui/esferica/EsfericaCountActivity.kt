...
class EsfericaCountActivity : AppCompatActivity(), IOnNotifyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.countKpiPanel.viewOffCatalogButton.visibility = View.GONE
        ...
        binding.countKpiPanel.sessionContextText.text = "${session.clientName}\n${session.warehouseName}"
    ...
    private fun refreshSessionCountLabels() {
        ...
        binding.countKpiPanel.expectedCountText.text = getString(R.string.esferica_expected_label, expected)

        binding.countKpiPanel.scannedMatchedCountText.text = getString(R.string.esferica_matched_unique_label, matched)

        binding.countKpiPanel.scannedOffCatalogText.text = getString(R.string.esferica_off_catalog_unique_label, offCatalog)
    ...
    private fun updateProductCompletionSummary() {
        ...
        val total = reconciledProducts.count { it.expectedQty > 0 }
    ...
    private fun updateReadButtons() {
        ...
        if (isReading) {
            ...
            binding.countKpiPanel.statusReadingText.text = getString(R.string.esferica_reading_running)

            binding.countKpiPanel.startReadButton.setText(R.string.esferica_stop_reading)
            ...
            binding.countKpiPanel.statusReadingText.text = getString(R.string.esferica_reading_stopped)

            binding.countKpiPanel.startReadButton.setText(R.string.esferica_start_reading)
