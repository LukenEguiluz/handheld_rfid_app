...
import com.dohealth.handheld.ui.continuous.ContinuousReadingActivity
...
import com.dohealth.handheld.ui.hgm.HgmSessionsActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupUI() {
        ...
        binding.deviceAddressText.text = deviceAddress.ifBlank { "—" }
    }
    ...
    private fun setupClickListeners() {
        ...
        // Lectura continua
        binding.continuousCard.setOnClickListener {
            startActivity(Intent(this, ContinuousReadingActivity::class.java).apply {
        ...
        binding.hgmCard.setOnClickListener {
            startActivity(Intent(this, HgmSessionsActivity::class.java).apply {
                putExtra("device_name", deviceName)
                putExtra("device_address", deviceAddress)
            })
        }
